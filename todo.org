...
** Site selection and performance modeling using data-driven approaches
  ...
  + Clara Cali Mella: how to handle different indications, in particular indications without a relevant amount of historical data? 
...
** Recruitment monitoring and forecasting: best practices and tools
  ...
  + Clara Cali Mella: which data sources could be used to predict recruitment? how to define which data is relevant? How to include diversity targets/requirements into modelling?
